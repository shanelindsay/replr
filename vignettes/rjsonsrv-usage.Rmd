---
title: "rjsonsrv: A Local JSON REPL"
author: "Package Maintainer"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{rjsonsrv: A Local JSON REPL}
...
`rjsonsrv` provides a lightweight HTTP server that executes R code and returns
...
res <- rjsonsrv::exec_code("summary(lm(mpg ~ cyl, data = mtcars))", port = 8123)
...
`rjsonsrv` makes it easy to evaluate R code from external clients or scripts and
